...
X_s_cubic, y = ip_stream_generator(X, y_, total_samples=50000, stream_features=2, random_state=91872, n_drifts=n_drfs, interpolation='cubic')
X_s_nearest, y = ip_stream_generator(X, y_, total_samples=50000, stream_features=2, random_state=91872, n_drifts=n_drfs, interpolation='nearest')
